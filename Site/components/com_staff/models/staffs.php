 ...
 */
class StaffModelStaffs extends JModelList
{
...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.name LIKE '.$search.'  OR  a.title LIKE '.$search.' )');
			}
		}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_STAFF_SEARCH_FILTER_DATE_FORMAT"), "warning");
