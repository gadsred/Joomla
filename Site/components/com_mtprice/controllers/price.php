 ...
 */
class MtpriceControllerPrice extends MtpriceController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Price', 'MtpriceModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_mtprice&view=priceform&layout=edit&Itemid=224'));
    }
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_mtprice') || $user->authorise('core.edit.state', 'com_mtprice')) {
            $model = $this->getModel('Price', 'MtpriceModel');
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_mtprice&view=prices', false));
            } else {
    ...
    public function remove() {
        ...
        //Checking if the user can remove object
        $user = JFactory::getUser();
        if ($user->authorise($user->authorise('core.delete', 'com_mtprice'))) {
            $model = $this->getModel('Price', 'MtpriceModel');
