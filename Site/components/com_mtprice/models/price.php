 ...
 * Mtprice model.
 */
class MtpriceModelPrice extends JModelItem {
    ...
    public function &getData($id = null) {
		...
		if ( isset($this->_item->user_id) ) {
			$this->_item->user_id_name = JFactory::getUser($this->_item->user_id)->name;
					...
					$this->_item->au_state = JText::_('COM_MTPRICE_PRICES_AU_STATE_OPTION_' . $this->_item->au_state);
					$this->_item->price_type = JText::_('COM_MTPRICE_PRICES_PRICE_TYPE_OPTION_' . $this->_item->price_type);
					$this->_item->keypoints_type = JText::_('COM_MTPRICE_PRICES_KEYPOINTS_TYPE_OPTION_' . $this->_item->keypoints_type);
