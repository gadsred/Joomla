 ...
 */
class FinancialControllerUpdatecard extends FinancialController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Updatecard', 'FinancialModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_financial') || $user->authorise('core.edit.state', 'com_financial')) {
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_financial&view=updatecards', false));
            } else {
