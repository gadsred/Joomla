...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_financial&task=updatecards.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'updatecardList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'updatecards.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_financial&task=updatecard.edit&id='.(int) $item->id); ?>">
