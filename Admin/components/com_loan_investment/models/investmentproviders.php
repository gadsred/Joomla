 ...
 * @since  1.6
 */
class Loan_investmentModelInvestmentproviders extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__loan_investment_providers` AS a');
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.provider_name LIKE ' . $search . '  OR  a.provider_logo LIKE ' . $search . ' )');
			}
		}
