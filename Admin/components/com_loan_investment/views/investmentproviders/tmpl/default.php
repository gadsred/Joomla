...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_loan_investment&task=investmentproviders.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'investmentproviderList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
			...
			<table class="table table-striped" id="investmentproviderList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'investmentproviders.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_loan_investment&task=investmentprovider.edit&id='.(int) $item->id); ?>">
