...
class FaqViewFaqs extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_FAQ_TITLE_FAQS'), 'faqs.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/faq';
	...
	protected function getSortFields()
	{
		...
		'a.link_id' => JText::_('COM_FAQ_FAQS_LINK_ID'),
		'a.question' => JText::_('COM_FAQ_FAQS_QUESTION'),
		'a.answer' => JText::_('COM_FAQ_FAQS_ANSWER'),
		);
	}
