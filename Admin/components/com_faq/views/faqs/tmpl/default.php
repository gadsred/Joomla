...
$canOrder  = $user->authorise('core.edit.state', 'com_faq');
$saveOrder = $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_faq&task=faqs.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'faqList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_faq&view=faqs'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="faqList">
				<thead>
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FAQ_FAQS_LINK_ID', 'a.link_id', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FAQ_FAQS_QUESTION', 'a.question', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_FAQ_FAQS_ANSWER', 'a.answer', $listDirn, $listOrder); ?>
				</th>
				...
				<?php if (isset($item->checked_out) && $item->checked_out) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'faqs.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_faq&task=faq.edit&id='.(int) $item->id); ?>">
